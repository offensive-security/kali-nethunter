...
fullnh="kali-linux-nethunter mana-toolkit exploitdb lua-sql-sqlite3 msfpc exe2hexbat bettercap fruitywifi libapache2-mod-php7.0 gcc-arm-none-eabi libreadline6-dev libncurses5-dev"
